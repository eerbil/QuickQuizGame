...
public class PhoneGameActivity extends AppCompatActivity implements GameFragment.TransitionListener {
    ...
    public void questionSelected(Question selected) {
        ...
        intent.putExtra(QuestionActivity.QUESTION_KEY, selected);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == QUESTION_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            GameFragment gf = (GameFragment) getSupportFragmentManager().findFragmentById(R.id.phoneGameFragment);
